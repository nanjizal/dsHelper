...
dsHelper_TestdsHelper.prototype = $extend(utest_Test.prototype,{
	testFloat32Flat_1: function() {
		var left;
		try {
			var ff = dsHelper_flat_io_Float32Flat._new(2);
			dsHelper_flat_io_Float32Flat.writeItem(ff,0,1.);
			left = dsHelper_flat_io_Float32Flat.readItem(ff,0) == 1.;
		} catch( _g ) {
			haxe_NativeStackTrace.saveStack(_g);
		...
		if(hx_doctest_internal_DocTestUtils.deepEquals(left,right)) {
			utest_Assert.pass("src/dsHelper/flat/io/Float32Flat.hx:10 [OK] ({\nvar ff = new Float32Flat(2);\nff[0] = 1.;\nff[0] == 1.; }) == true",{ lineNumber : 10, fileName : "src/dsHelper/flat/io/Float32Flat.hx", charStart : 10, className : "", charEnd : 14, methodName : ""});
		} else {
			utest_Assert.fail("({\nvar ff = new Float32Flat(2);\nff[0] = 1.;\nff[0] == 1.; }) == true --> Left side `$left` does not equal `$right`.",{ lineNumber : 10, fileName : "src/dsHelper/flat/io/Float32Flat.hx", charStart : 10, className : "", charEnd : 14, methodName : ""});
		}
		var left;
		try {
			var ff = dsHelper_flat_io_Float32Flat._new(2);
		...
		if(hx_doctest_internal_DocTestUtils.deepEquals(left,right)) {
			utest_Assert.pass("src/dsHelper/flat/io/Float32Flat.hx:23 [OK] ({\nvar ff = new Float32Flat(2);\nff[0] = 1.;\nff[0] == 1.; }) == true",{ lineNumber : 23, fileName : "src/dsHelper/flat/io/Float32Flat.hx", charStart : 10, className : "", charEnd : 14, methodName : ""});
		} else {
			utest_Assert.fail("({\nvar ff = new Float32Flat(2);\nff[0] = 1.;\nff[0] == 1.; }) == true --> Left side `$left` does not equal `$right`.",{ lineNumber : 23, fileName : "src/dsHelper/flat/io/Float32Flat.hx", charStart : 10, className : "", charEnd : 14, methodName : ""});
		}
	}
	,__initializeUtest__: function() {
		var _gthis = this;
...
dsHelper_flat_io_Float32Flat.__properties__ = {set_pos:"set_pos",get_pos:"get_pos",set_index:"set_index",get_index:"get_index",set_size:"set_size",get_size:"get_size"};
dsHelper_flat_io_Float32Flat.readItem = function(this1,k) {
	return haxe_io_Float32Array.get(this1,k + 2);
};
dsHelper_flat_io_Float32Flat.writeItem = function(this1,k,v) {
	haxe_io_Float32Array.set(this1,k + 2,v);
	return v;
};
dsHelper_flat_io_Float32Flat._new = function(len) {
	var this1 = haxe_io_Float32Array._new(len + 2);
	haxe_io_Float32Array.set(this1,0,0.);
	haxe_io_Float32Array.set(this1,1,0.);
	return this1;
};
dsHelper_flat_io_Float32Flat.get_size = function(this1) {
	return haxe_io_Float32Array.get(this1,1) | 0;
};
dsHelper_flat_io_Float32Flat.set_size = function(this1,id) {
	dsHelper_flat_io_Float32Flat.set_pos(this1,id);
	return id;
};
dsHelper_flat_io_Float32Flat.get_index = function(this1) {
	return dsHelper_flat_io_Float32Flat.get_pos(this1) | 0;
};
dsHelper_flat_io_Float32Flat.set_index = function(this1,id) {
	dsHelper_flat_io_Float32Flat.set_pos(this1,id);
	return id;
};
dsHelper_flat_io_Float32Flat.get_pos = function(this1) {
	return haxe_io_Float32Array.get(this1,0);
};
dsHelper_flat_io_Float32Flat.set_pos = function(this1,pos_) {
	haxe_io_Float32Array.set(this1,0,pos_);
	dsHelper_flat_io_Float32Flat.updateLen(this1);
	return pos_;
};
dsHelper_flat_io_Float32Flat.updateLen = function(this1) {
	if(haxe_io_Float32Array.get(this1,0) > haxe_io_Float32Array.get(this1,1) - 1) {
		haxe_io_Float32Array.set(this1,1,haxe_io_Float32Array.get(this1,0));
	}
};
dsHelper_flat_io_Float32Flat.hasNext = function(this1) {
	return dsHelper_flat_io_Float32Flat.get_pos(this1) < dsHelper_flat_io_Float32Flat.get_size(this1);
};
dsHelper_flat_io_Float32Flat.next = function(this1) {
	dsHelper_flat_io_Float32Flat.set_pos(this1,dsHelper_flat_io_Float32Flat.get_pos(this1) + 1.);
	return dsHelper_flat_io_Float32Flat.get_pos(this1);
};
dsHelper_flat_io_Float32Flat.increment = function(this1) {
	return dsHelper_flat_io_Float32Flat.next(this1);
};
dsHelper_flat_io_Float32Flat.toArray = function(this1) {
	return haxe_io_Float32Array.subarray(this1,2,haxe_io_Float32Array.get_length(this1) - 2);
};
dsHelper_flat_io_Float32Flat.fromArray = function(arr) {
	var flat = dsHelper_flat_io_Float32Flat._new(haxe_io_Float32Array.get_length(arr));
	dsHelper_flat_io_Float32Flat.fill(flat,arr);
	return flat;
};
dsHelper_flat_io_Float32Flat.clone = function(this1) {
	var flat = dsHelper_flat_io_Float32Flat._new(haxe_io_Float32Array.get_length(this1) - 2);
	dsHelper_flat_io_Float32Flat.fill(flat,dsHelper_flat_io_Float32Flat.toArray(this1));
	return flat;
};
dsHelper_flat_io_Float32Flat.fill = function(this1,arr) {
	var l = haxe_io_Float32Array.get_length(arr);
	var _g = 0;
	var _g1 = l;
	while(_g < _g1) {
		var i = _g++;
		haxe_io_Float32Array.set(this1,i + 2,haxe_io_Float32Array.get(arr,i));
	}
	haxe_io_Float32Array.set(this1,0,0);
	haxe_io_Float32Array.set(this1,1,l);
};
...
haxe_io_Float32Array.__properties__ = {get_length:"get_length"};
