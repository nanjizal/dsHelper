...
var dsHelper_TestdsHelper = function() {
	utest_Test.call(this);
};
dsHelper_TestdsHelper.__name__ = "dsHelper.TestdsHelper";
dsHelper_TestdsHelper.main = function() {
	var runner = new utest_Runner();
	runner.addCase(new dsHelper_TestdsHelper());
	utest_ui_Report.create(runner);
	runner.run();
};
dsHelper_TestdsHelper.__super__ = utest_Test;
dsHelper_TestdsHelper.prototype = $extend(utest_Test.prototype,{
	testFloat32Flat_1: function() {
		...
		if(hx_doctest_internal_DocTestUtils.deepEquals(left,right)) {
			utest_Assert.pass("src/dsHelper/flat/f32/Float32Flat.hx:10 [OK] ({\nvar ff = new Float32Flat(2);\nff[0] = 1.;\nff[0] == 1.; }) == true",{ lineNumber : 10, fileName : "src/dsHelper/flat/f32/Float32Flat.hx", charStart : 10, className : "", charEnd : 14, methodName : ""});
		} else {
			utest_Assert.fail("({\nvar ff = new Float32Flat(2);\nff[0] = 1.;\nff[0] == 1.; }) == true --> Left side `$left` does not equal `$right`.",{ lineNumber : 10, fileName : "src/dsHelper/flat/f32/Float32Flat.hx", charStart : 10, className : "", charEnd : 14, methodName : ""});
		}
		var left;
		try {
			var this1 = new Float32Array(4);
		...
		if(hx_doctest_internal_DocTestUtils.deepEquals(left,right)) {
			utest_Assert.pass("src/dsHelper/flat/f32/Float32Flat.hx:23 [OK] ({\nvar ff = new Float32Flat(2);\nff[0] = 1.;\nff[0] == 1.; }) == true",{ lineNumber : 23, fileName : "src/dsHelper/flat/f32/Float32Flat.hx", charStart : 10, className : "", charEnd : 14, methodName : ""});
		} else {
			utest_Assert.fail("({\nvar ff = new Float32Flat(2);\nff[0] = 1.;\nff[0] == 1.; }) == true --> Left side `$left` does not equal `$right`.",{ lineNumber : 23, fileName : "src/dsHelper/flat/f32/Float32Flat.hx", charStart : 10, className : "", charEnd : 14, methodName : ""});
		}
	}
	,testFlat32_1: function() {
		var left;
		try {
			var this1 = new Float32Array(4);
			var this2 = this1;
		...
		if(hx_doctest_internal_DocTestUtils.deepEquals(left,right)) {
			utest_Assert.pass("src/dsHelper/flatInterleave/core/Flat32.hx:10 [OK] ({\nvar ff = new Flat32(2);\nff[0] = 1.;\nff[0] == 1.; }) == true",{ lineNumber : 10, fileName : "src/dsHelper/flatInterleave/core/Flat32.hx", charStart : 10, className : "", charEnd : 14, methodName : ""});
		} else {
			utest_Assert.fail("({\nvar ff = new Flat32(2);\nff[0] = 1.;\nff[0] == 1.; }) == true --> Left side `$left` does not equal `$right`.",{ lineNumber : 10, fileName : "src/dsHelper/flatInterleave/core/Flat32.hx", charStart : 10, className : "", charEnd : 14, methodName : ""});
		}
		var left;
		try {
			var this1 = new Float32Array(4);
		...
		if(hx_doctest_internal_DocTestUtils.deepEquals(left,right)) {
			utest_Assert.pass("src/dsHelper/flatInterleave/core/Flat32.hx:23 [OK] ({\nvar ff = new Flat32(2);\nff[0] = 1.;\nff[0] == 1.; }) == true",{ lineNumber : 23, fileName : "src/dsHelper/flatInterleave/core/Flat32.hx", charStart : 10, className : "", charEnd : 14, methodName : ""});
		} else {
			utest_Assert.fail("({\nvar ff = new Flat32(2);\nff[0] = 1.;\nff[0] == 1.; }) == true --> Left side `$left` does not equal `$right`.",{ lineNumber : 23, fileName : "src/dsHelper/flatInterleave/core/Flat32.hx", charStart : 10, className : "", charEnd : 14, methodName : ""});
		}
	}
	,__initializeUtest__: function() {
		var _gthis = this;
		...
		init.tests.push({ name : "testFlat32_1", execute : function() {
			_gthis.testFlat32_1();
			return utest_Async.getResolved();
		}});
		return init;
	}
	,__class__: dsHelper_TestdsHelper
});
var dsHelper_flat_f32_Float32Flat = {};
dsHelper_flat_f32_Float32Flat.__properties__ = {set_pos:"set_pos",get_pos:"get_pos",set_index:"set_index",get_index:"get_index",set_size:"set_size",get_size:"get_size"};
dsHelper_flat_f32_Float32Flat.readItem = function(this1,k) {
	return this1[k + 2];
};
dsHelper_flat_f32_Float32Flat.writeItem = function(this1,k,v) {
	this1[k + 2] = v;
	return v;
};
dsHelper_flat_f32_Float32Flat._new = function(len) {
...
dsHelper_flat_f32_Float32Flat.get_size = function(this1) {
	return Std.int(this1[1]);
};
dsHelper_flat_f32_Float32Flat.set_size = function(this1,id) {
	var pos_ = id;
	this1[0] = pos_;
...
dsHelper_flat_f32_Float32Flat.get_index = function(this1) {
	return Std.int(this1[0]);
};
dsHelper_flat_f32_Float32Flat.set_index = function(this1,id) {
	this1[0] = id;
	if(this1[0] > this1[1] - 1) {
		this1[1] = this1[0];
	}
...
dsHelper_flat_f32_Float32Flat.get_pos = function(this1) {
	return this1[0];
};
dsHelper_flat_f32_Float32Flat.set_pos = function(this1,pos_) {
	this1[0] = pos_;
	if(this1[0] > this1[1] - 1) {
		this1[1] = this1[0];
	}
...
dsHelper_flat_f32_Float32Flat.updateLen = function(this1) {
	if(this1[0] > this1[1] - 1) {
		this1[1] = this1[0];
	}
};
dsHelper_flat_f32_Float32Flat.hasNext = function(this1) {
	return this1[0] < dsHelper_flat_f32_Float32Flat.get_size(this1);
};
dsHelper_flat_f32_Float32Flat.next = function(this1) {
	var pos_ = this1[0] + 1.;
	this1[0] = pos_;
	if(this1[0] > this1[1] - 1) {
		this1[1] = this1[0];
...
dsHelper_flat_f32_Float32Flat.increment = function(this1) {
	var pos_ = this1[0] + 1.;
	this1[0] = pos_;
	if(this1[0] > this1[1] - 1) {
		this1[1] = this1[0];
...
dsHelper_flat_f32_Float32Flat.toArray = function(this1) {
	return this1.subarray(2,this1.length - 2);
};
dsHelper_flat_f32_Float32Flat.fromArray = function(arr) {
...
dsHelper_flat_f32_Float32Flat.clone = function(this1) {
	var this2 = new Float32Array(this1.length - 2 + 2);
	var this3 = this2;
	this3[0] = 0.;
	this3[1] = 0.;
	var flat = this3;
	var arr = this1.subarray(2,this1.length - 2);
	var l = arr.length;
	var _g = 0;
	var _g1 = l;
	while(_g < _g1) {
...
dsHelper_flat_f32_Float32Flat.fill = function(this1,arr) {
	var l = arr.length;
	var _g = 0;
	var _g1 = l;
	while(_g < _g1) {
...
dsHelper_flatInterleave_core_Flat32.__properties__ = {set_pos:"set_pos",get_pos:"get_pos",set_index:"set_index",get_index:"get_index",set_size:"set_size",get_size:"get_size"};
dsHelper_flatInterleave_core_Flat32.readItem = function(this1,k) {
	return this1[k + 2];
};
dsHelper_flatInterleave_core_Flat32.writeItem = function(this1,k,v) {
	this1[k + 2] = v;
	return v;
};
dsHelper_flatInterleave_core_Flat32._new = function(len) {
	var this1 = new Float32Array(len + 2);
	var this2 = this1;
	this2[0] = 0.;
	this2[1] = 0.;
...
dsHelper_flatInterleave_core_Flat32.get_index = function(this1) {
	return Std.int(this1[0]);
};
dsHelper_flatInterleave_core_Flat32.set_index = function(this1,id) {
	this1[0] = id;
	if(this1[0] > this1[1] - 1) {
		this1[1] = this1[0];
	}
...
dsHelper_flatInterleave_core_Flat32.get_pos = function(this1) {
	return this1[0];
};
dsHelper_flatInterleave_core_Flat32.set_pos = function(this1,pos_) {
	this1[0] = pos_;
	if(this1[0] > this1[1] - 1) {
		this1[1] = this1[0];
	}
...
dsHelper_flatInterleave_core_Flat32.updateLen = function(this1) {
	if(this1[0] > this1[1] - 1) {
		this1[1] = this1[0];
	}
};
dsHelper_flatInterleave_core_Flat32.hasNext = function(this1) {
	return this1[0] < dsHelper_flatInterleave_core_Flat32.get_size(this1);
};
dsHelper_flatInterleave_core_Flat32.next = function(this1) {
	var pos_ = this1[0] + 1.;
	this1[0] = pos_;
	if(this1[0] > this1[1] - 1) {
		this1[1] = this1[0];
...
dsHelper_flatInterleave_core_Flat32.increment = function(this1) {
	var pos_ = this1[0] + 1.;
	this1[0] = pos_;
	if(this1[0] > this1[1] - 1) {
		this1[1] = this1[0];
...
dsHelper_flatInterleave_core_Flat32.toArray = function(this1) {
	return this1.subarray(2,this1.length - 2);
};
dsHelper_flatInterleave_core_Flat32.fromArray = function(arr) {
	var this1 = new Float32Array(arr.length + 2);
	var this2 = this1;
	this2[0] = 0.;
	this2[1] = 0.;
...
dsHelper_flatInterleave_core_Flat32.clone = function(this1) {
	var this2 = new Float32Array(this1.length - 2 + 2);
	var this3 = this2;
	this3[0] = 0.;
	this3[1] = 0.;
...
dsHelper_flatInterleave_core_Flat32.fill = function(this1,arr) {
	var l = arr.length;
	var _g = 0;
	var _g1 = l;
	while(_g < _g1) {
